...
public class SaralTreeWalkListener extends SaralBaseListener {
    Queue<Instruction> instructionsQueue = new ArrayDeque<>();
    Map<String, Variable> variables = new HashMap<>();

    @Override
    public void exitVariable(SaralParser.VariableContext ctx) {
    ...
    @Override
    public void exitPrint(SaralParser.PrintContext ctx) {
        TerminalNode varName = ctx.ID();
